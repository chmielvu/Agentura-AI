...
}> = ({ persona, onPersonaChange, mode, onModeChange }) => (
  <header className="bg-card p-4 border-b border-border fixed top-0 left-0 right-0 z-20">
    <div className="max-w-4xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
      ...
      <div className='flex flex-col items-end gap-2'>
        {/* NEW Mode Switch UI */}
        <div className="flex items-center bg-background rounded-sm p-1 border border-border order-1 sm:order-2">
        ...
        {/* Existing Persona Switch UI */}
        <div className="flex items-center bg-background rounded-sm p-1 border border-border order-2 sm:order-1">
